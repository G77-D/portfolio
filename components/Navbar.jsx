			...
			<div className="flex justify-between w-full h-full px-2 2xl:px-16">
				...
				<div>
					<ul className="hidden md:flex">
						...
						<Link href="/">
							<li className="ml-10 test-sm uppercase hover:border-b">About</li>
						</Link>
						<Link href="/">
							<li className="ml-10 test-sm uppercase hover:border-b">Skills</li>
						</Link>
						<Link href="/">
							<li className="ml-10 test-sm uppercase hover:border-b">
								Project
							</li>
						</Link>
						<Link href="/">
